...
- **Technical notes**: Key implementation details, relevant files, patterns to follow
- **Dependencies**: Any issues that must be completed first

Create the issues in implementation order. Record each issue number as it is created.
