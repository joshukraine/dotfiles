...
- **Total abbreviations**: 285 (288 in Fish, 285 in Zsh)
- **Categories**: 23
...
| Abbr    | Command                                                           | Description                                           |
| ------- | ----------------------------------------------------------------- | ----------------------------------------------------- |
| `mdl`   | `markdownlint-cli2 --config ~/.markdownlint.yaml "*.md"`          | Lint markdown files in current directory              |
| `mdlf`  | `markdownlint-cli2 --config ~/.markdownlint.yaml --fix "*.md"`    | Lint and auto-fix markdown files in current directory |
...
| `mdv`   | `markdown-validate`                                               | Validate markdown with dotfiles config (detailed)     |
| `mdvf`  | `markdown-validate --fix`                                         | Validate and auto-fix markdown with dotfiles config   |
| `mdvq`  | `markdown-validate --fix --quiet`                                 | Quick markdown validation and fix (minimal output)    |
...
_Last generated: Fri Aug 1 21:09:49 EEST 2025_
