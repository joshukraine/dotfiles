...
| `mdv`   | `./scripts/validate-config.sh -v markdown`                        | Validate markdown with dotfiles config (detailed)   |
| `mdvf`  | `./scripts/validate-config.sh -v markdown --fix`                  | Validate and auto-fix markdown with dotfiles config |
| `mdvq`  | `./scripts/validate-config.sh -v markdown --fix --quiet`          | Quick markdown validation and fix (minimal output)  |
...
_Last generated: Fri Aug 1 20:58:28 EEST 2025_
