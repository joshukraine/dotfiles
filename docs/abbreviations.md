...
- **Total abbreviations**: 286 (288 in Fish, 286 in Zsh)
- **Categories**: 23
...
| Abbr    | Command                                                                | Description                                                      |
| ------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------- |
| `mdl`   | `markdownlint-cli2 --config ~/.markdownlint-cli2.yaml "**/*.md"`       | Lint all markdown files in project (recursive)                   |
| `mdlf`  | `markdownlint-cli2 --config ~/.markdownlint-cli2.yaml --fix "**/*.md"` | Lint and auto-fix all markdown files in project (recursive)      |
| `mdlc`  | `markdownlint-cli2 --config ~/.markdownlint-cli2.yaml "*.md"`          | Lint markdown files in current directory only                    |
| `mdlcf` | `markdownlint-cli2 --config ~/.markdownlint-cli2.yaml --fix "*.md"`    | Lint and auto-fix markdown files in current directory only       |
| `mdla`  | `markdownlint-cli2 --config ~/.markdownlint-cli2.yaml "**/*.md"`       | Lint all markdown files in project (alias for mdl)               |
| `mdlaf` | `markdownlint-cli2 --config ~/.markdownlint-cli2.yaml --fix "**/*.md"` | Lint and auto-fix all markdown files in project (alias for mdlf) |
...
_Last generated: Fri Feb 6 22:28:02 EET 2026_
