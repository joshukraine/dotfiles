...
VALIDATORS:
    abbreviations        Validate abbreviation consistency
    environment          Validate environment variables
    shell-syntax         Validate shell syntax
    dependencies         Validate required dependencies
    symlinks             Validate symlink integrity
...
EXAMPLES:
    ...
    ./validate-config.sh -v abbreviations   # Run only abbreviations validator
