...
abbr "mdv"="./scripts/validate-config.sh -v markdown"
abbr "mdvf"="./scripts/validate-config.sh -v markdown --fix"
abbr "mdvq"="./scripts/validate-config.sh -v markdown --fix --quiet"
