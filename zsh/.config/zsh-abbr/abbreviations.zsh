...
abbr "mdla"="markdownlint-cli2 --config ~/.markdownlint-cli2.yaml "**/*.md""
abbr "mdlaf"="markdownlint-cli2 --config ~/.markdownlint-cli2.yaml --fix "**/*.md""
...
abbr "gt"="git tag"
abbr "gfzf"="source ${DOTFILES}/bin/fzf-git.sh"
abbr "gfzff"="fzf-git.sh --run files"
abbr "gfzfb"="fzf-git.sh --run branches"
abbr "gfzft"="fzf-git.sh --run tags"
abbr "gfzfr"="fzf-git.sh --run remotes"
abbr "gfzfh"="fzf-git.sh --run hashes"
abbr "gfzfs"="fzf-git.sh --run stashes"
abbr "gfzfl"="fzf-git.sh --run lreflogs"
abbr "gfzfe"="fzf-git.sh --run each_ref"
abbr "gfzfw"="fzf-git.sh --run worktrees"
...
abbr "msbc"="tmuxinator start bfc"
