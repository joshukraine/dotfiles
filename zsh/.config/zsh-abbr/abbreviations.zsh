...
# abbr "gcom"="git checkout master" # Use gcom function instead.
...
# abbr "gpum"="git push -u origin master" # Use gpum function instead
...
# abbr "grbm"="git rebase master" # Use grbm function instead
abbr "gre"="git reset"
