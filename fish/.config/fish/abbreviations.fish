...
# markdown
abbr -a -g mdl 'markdownlint-cli2 --config ~/.markdownlint-cli2.yaml "**/*.md"'
abbr -a -g mdlf 'markdownlint-cli2 --config ~/.markdownlint-cli2.yaml --fix "**/*.md"'
abbr -a -g mdlc 'markdownlint-cli2 --config ~/.markdownlint-cli2.yaml "*.md"'
abbr -a -g mdlcf 'markdownlint-cli2 --config ~/.markdownlint-cli2.yaml --fix "*.md"'
abbr -a -g mdla 'markdownlint-cli2 --config ~/.markdownlint-cli2.yaml "**/*.md"'
abbr -a -g mdlaf 'markdownlint-cli2 --config ~/.markdownlint-cli2.yaml --fix "**/*.md"'
...
abbr -a -g gt 'git tag'
abbr -a -g gfzf 'source $DOTFILES/bin/fzf-git.sh'
abbr -a -g gfzff 'fzf-git.sh --run files'
abbr -a -g gfzfb 'fzf-git.sh --run branches'
abbr -a -g gfzft 'fzf-git.sh --run tags'
abbr -a -g gfzfr 'fzf-git.sh --run remotes'
abbr -a -g gfzfh 'fzf-git.sh --run hashes'
abbr -a -g gfzfs 'fzf-git.sh --run stashes'
abbr -a -g gfzfl 'fzf-git.sh --run lreflogs'
abbr -a -g gfzfe 'fzf-git.sh --run each_ref'
abbr -a -g gfzfw 'fzf-git.sh --run worktrees'
...
abbr -a -g msbc 'tmuxinator start bfc'
