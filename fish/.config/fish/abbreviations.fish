...
abbr -a -g gl 'git l'
abbr -a -g glg 'git lg'
abbr -a -g gll 'git log --graph --format=format:'%C(bold blue)%h%C(reset) - %C(bold green)(%ar)%C(reset) %C(white)%s%C(reset) %C(bold white)— %an%C(reset)%C(bold yellow)%d%C(reset)' --abbrev-commit'
...
abbr -a -g dcup 'docker-compose up'
abbr -a -g dcupb 'docker-compose up --build'
abbr -a -g dcupd 'docker-compose up -d'
abbr -a -g dcupdb 'docker-compose up -d --build'
abbr -a -g de 'docker exec'
abbr -a -g dei 'docker exec -i'
abbr -a -g deit 'docker exec -it'
abbr -a -g dexec 'docker exec'
...
abbr -a -g rdbr 'bin/rails db:rollback'
abbr -a -g rdbs 'bin/rails db:seed'
abbr -a -g rdbms 'bin/rails db:migrate:status'
abbr -a -g rg 'bin/rails generate'
abbr -a -g rgc 'bin/rails generate controller'
abbr -a -g rgm 'bin/rails generate model'
abbr -a -g rgmig 'bin/rails generate migration'
...
abbr -a -g rsp 'bin/rails server --port'
...
abbr -a -g gest 'gem list'
abbr -a -g gi 'gem install'
abbr -a -g gun 'gem uninstall'

# Asdf
abbr -a -g ala 'asdf list all'
abbr -a -g ali 'asdf list'
abbr -a -g aui 'asdf install'
abbr -a -g aal 'asdf list all'
